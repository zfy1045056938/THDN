...
public class Player : MonoBehaviour, ICharacter
{
    ...
    #region Discover Module
    //For spell und effect
    //Spawn rnd 3 card in the discover manager panel,accord to card effect have 3 way to discover
    //1.player deck
    //2.CardCollection
    //3.classes card list
    //4.
    ...
    public void DiscoverCardRnd(int amount){

    }

     public void DiscoverCardRnd(int amount ,string classes,Player owner){

    }
#endregion
    
    #region GenerateRnd Card
